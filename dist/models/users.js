...
var UserStore = /** @class */ (function () {
    ...
    UserStore.prototype.authenticate = function (lastname) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = 'SELECT * FROM users WHERE lastname=($1)';
                        return [4 /*yield*/, database_1["default"].connect()];
                    case 1:
                        conn = _a.sent();
                    ...
                    case 3:
                        error_4 = _a.sent();
                        throw new Error("User ".concat(lastname, " does not exist. Error: ").concat(error_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
