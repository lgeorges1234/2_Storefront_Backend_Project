...
var authenticate = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, authenticateUser, token, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                user = {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, store.authenticate(user.lastname)];
            case 2:
                authenticateUser = _a.sent();
                token = jsonwebtoken_1["default"].sign({ user: authenticateUser }, process.env.TOKEN_SECRET);
                res.json(token);
                return [3 /*break*/, 4];
            case 3:
                error_2 = _a.sent();
